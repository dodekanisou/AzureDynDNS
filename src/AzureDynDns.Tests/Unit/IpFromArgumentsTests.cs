...
public class IpFromArgumentsTests
{
    ...
    public async Task Returns_correct_argument(int index, string expected_value)
    {
        // Prepare - The service
    ...
    [Fact]
    public async Task Throws_exceptions_if_no_arguments_passedAsync()
    {
        // Prepare - The service
        var config = new IpFromArgumentsConfiguration()
        {
    ...
    [Fact]
    public async Task Throws_exceptions_on_negative_argument_indexAsync()
    {
        // Prepare - The service
        var config = new IpFromArgumentsConfiguration()
        {
    ...
    [Fact]
    public async Task Throws_exceptions_on_out_of_bounds_argument_indexAsync()
    {
        // Prepare - The service
        var config = new IpFromArgumentsConfiguration()
        {
            Arguments = ArgumentsList,
            ArgumentIndex = ArgumentsList.Count()
        };
        var service = new IpFromArgumentsService(config, logger);
